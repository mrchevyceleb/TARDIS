export type ControlStatus = { supported: boolean; reason?: string; control: { owner: string; label: string; purpose: string; expiresAt: number } | null };
...
export class ComputerController {
  constructor(options: { approve: (request: ControlRequest, signal: AbortSignal) => Promise<boolean>; changed?: (status: ControlStatus) => void;
