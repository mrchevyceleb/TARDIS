...
export type ContentDraft = {
  ...
  payload: { posts?: ContentPost[]; featured_image?: ContentImage; video_url?:string; beats?:Array<{beat:number;on_screen_text:string;visual_prompt:string}>; [key: string]: unknown };
